...
hostRouter.post("/add-home", (req, res) => {
    houseRegistered.push({ houseName: req.body.housename, price: req.body.price, location: req.body.location, img: req.body.img });
    console.log("registerd house : ", houseRegistered);
    res.render("home-added", { houseRegistered, pageTitle: "Home added successfully!" });
})
